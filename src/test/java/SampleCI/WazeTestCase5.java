...
public class WazeTestCase5 {
	...
	public void setUp(String deviceName, String OS) throws Exception {
		...
		PerfectoExecutionContext perfectoExecutionContext = new PerfectoExecutionContext.PerfectoExecutionContextBuilder()
				...
				.withContextTags("TC5").withWebDriver(driver).build();
	...
	public void test() throws InterruptedException {
		try {
			...
			reportiumClient.testStart("WazeTestCase5",
					new TestContext.Builder().withTestExecutionTags("Audio Testing")
...
//					Thread.sleep(30000);
				...
				params.put("location", "50%,50%,50%,50%");
				...
				driver.findElement(By.xpath("//*[@resource-id=\"com.waze:id/defaultSpeechRecognitionButtonView\"]")).click();
				driver.findElementByXPath("//*[@text='Allow']").click();
				AudioUtilities.injectAudio(driver, "PUBLIC:FILE.wav");
				//
